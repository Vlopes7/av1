...
function gerenciarAeronaves() {
    ...
    switch (opcao) {
        case '1':
            ...
            var tipoKeys = Object.keys(enum_1.tipoAeronave).filter(function (key) { return isNaN(Number(key)); });
...
function gerenciarPecas() {
    ...
    switch (opcao) {
        case '1':
            ...
            var tipoPecaKeys = Object.keys(enum_1.tipoPeca).filter(function (key) { return isNaN(Number(key)); });
        ...
        case '3':
            ...
            var statusKeys = Object.keys(enum_1.statusPeca).filter(function (key) { return isNaN(Number(key)); });
...
function gerenciarFuncionarios() {
    ...
    switch (opcao) {
        case '1':
            ...
            var hierarquiaKeys = Object.keys(enum_1.hierarquia).filter(function (key) { return isNaN(Number(key)); });
...
function gerenciarEtapas() {
    ...
    switch (opcao) {
        case '1':
            ...
            var nomesFuncionarios = readlineSync.question('Nomes dos funcionarios (separados por virgula): ').split(',');
